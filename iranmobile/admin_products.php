    ...
    <table style="width: 100%;" border="0" style="margin-left: auto;margin-right: auto;">
        ...
        <tr>
            ...
            <td style="width: 78%;"><input type="text" id="pro_code" name="pro_code"
                    value="<?php echo ($pro_code) ?>" /></td>
        </tr>

        <tr>
            <td>نام کالا <span style="color: red;">*</span></td>
            <td><input type="text" style="text-align: right;" id="pro_name" name="pro_name"
        ...
        <tr>
            <td><br /><br /></td>
            <td><input type="submit" value="<?php echo ($btn_caption) ?>" />&nbsp;&nbsp;&nbsp;<input type="reset"
                    value="جديد" /></td>
        </tr>
